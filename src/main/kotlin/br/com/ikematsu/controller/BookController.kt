...
import br.com.ikematsu.proxy.CambioProxy
import br.com.ikematsu.repository.BookRepository
import br.com.ikematsu.response.Cambio
...
class BookController {
    ...
    fun findBook(
        ...
        book.environment = "BOOK PORT: $port CÂMBIO PORT: ${cambio!!.environment}"
